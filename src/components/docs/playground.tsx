...
const PLAYGROUND_ENDPOINTS: PlaygroundEndpoint[] = [
    ...
    },
    {
        id: 'list-cl',
        method: 'GET',
        path: '/api/v1/resumes/{id}/cover-letters',
    ...
    },
    {
        id: 'get-cl',
        method: 'GET',
        path: '/api/v1/resumes/{id}/cover-letters/{clId}',
    ...
    },
    {
        id: 'regen-cl',
        method: 'POST',
        path: '/api/v1/resumes/{id}/cover-letters/{clId}/regenerate',
    ...
    },
    {
        id: 'list-outreach',
        method: 'GET',
        path: '/api/v1/resumes/{id}/outreach',
        label: 'List Outreach',
        pathParams: ['id'],
        queryFields: [
            { key: 'limit', label: 'limit', type: 'number', defaultValue: 10 },
    ...
    },
    {
        id: 'get-outreach',
        method: 'GET',
        path: '/api/v1/resumes/{id}/outreach/{oId}',
        label: 'Get Outreach',
        pathParams: ['id', 'oId'],
    },
    {
    ...
    },
    {
        id: 'regen-outreach',
        method: 'POST',
        path: '/api/v1/resumes/{id}/outreach/{oId}/regenerate',
    ...
    },
    {
        ...
        bodyFields: [
            ...
            { key: 'enable_outreach_message', label: 'Enable outreach', type: 'boolean', defaultValue: false },
